...
import com.lym.security.browser.handler.BrowserAuthenticationFailureHandler;
import com.lym.security.browser.handler.BrowserAuthenticationSuccessHandler;
import com.lym.security.browser.handler.BrowserLogoutSuccessHandler;
import com.lym.security.browser.properties.BrowserProperties;
import com.lym.security.browser.session.ConcurrentLogInExpiredSessionStrategy;
import com.lym.security.browser.session.DefaultInvalidSessionStrategy;
...
public class BrowserBeanConfig {
    ...
    public InvalidSessionStrategy invalidSessionStrategy() {
        return new DefaultInvalidSessionStrategy(browserProperties);
    }
    ...
    public SessionInformationExpiredStrategy sessionInformationExpiredStrategy() {
        return new ConcurrentLogInExpiredSessionStrategy(browserProperties);
    }
